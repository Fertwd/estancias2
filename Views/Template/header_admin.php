...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Disfruta del mejor café, bebidas y postres en un ambiente relajado. Perfecto para pasar el rato, estudiar o compartir momentos especiales.">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Fer - Ale">
  ...
  <body class="app sidebar-mini">
      <!-- Navbar-->    
<header class="app-header"><a class="app-header__logo" href="<?= base_url(); ?>/dashboard">Boba Time and Coffe</a>
